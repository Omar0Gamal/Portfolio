...
import me.cmplayMC.OSAC.events.CheckManager;
import me.cmplayMC.OSAC.events.JoinLeaveListener;
...
public class Main extends JavaPlugin {
	...
	public static void log(User u, CheckResult result) {
		...
		String message = DARK_PURPLE.toString() + BOLD + "OSAC: " + AQUA.toString() + u.getPlayer().getName() + GRAY + " tried to use " + RED + result.getType().getName();
		if (!SIMPLE_LOG)
